...
y un puerto el cual se especifica en la variable creada "port"
Una vez establecida la conexión se envía una petición la cual esta almacenada en la variable "message"
